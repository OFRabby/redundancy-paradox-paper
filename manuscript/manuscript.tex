...
% Paragraph 5: Roadmap.
The remainder of this paper is organized as follows. Section~\ref{sec:related} reviews related work. Section~\ref{sec:formulation} presents the problem formulation. Section~\ref{sec:phase2} describes the controlled ground-truth study. Section~\ref{sec:phase3} presents the real-data multi-dataset evaluation. Section~\ref{sec:fragility} analyzes seed fragility. Section~\ref{sec:phase4} proposes uncertainty-aware ensemble selection. Section~\ref{sec:discussion} discusses implications and limitations. Section~\ref{sec:guidelines} provides practical guidelines. Section~\ref{sec:conclusion} concludes.
...
% Fixed epsilon is arbitrary; can we do better?

\subsection{Uncertainty-aware selection}
% Bootstrap-CI, sign+materiality, inner-tolerance.
